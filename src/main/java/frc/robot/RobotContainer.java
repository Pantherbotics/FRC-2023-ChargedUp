...
public class RobotContainer {
    ...
    private final String[] autos = {
            "High Goal and Taxi", "High Goal", "Taxi", "Two High Goal Top Side", "Two High Goal",
            "Cone and Cube High Goal"
    };
    ...
    private final JoystickButton secondaryJoystickStartButton = new JoystickButton(secondaryJoystick, 8); // Start
                                                                                                          // Button
    ...
    private void configButtonBindings() {
        ...
        primaryJoystickAButton
                .onTrue(new InstantCommand(() -> drivetrain.setDriveMode(DriveMode.ROBOT_ORIENTED_SWERVE)));
        primaryJoystickBButton
                .onTrue(new InstantCommand(() -> drivetrain.setDriveMode(DriveMode.FIELD_ORIENTED_SWERVE)));
    ...
    public void updateSmartDashboard() {
        ...
        drivetrain.getModules()[0].setOffsetAngle(
                SmartDashboard.getNumber("Swerve Module [1] Offset", drivetrain.getModules()[0].getOffsetAngle()));
        drivetrain.getModules()[1].setOffsetAngle(
                SmartDashboard.getNumber("Swerve Module [2] Offset", drivetrain.getModules()[1].getOffsetAngle()));
        drivetrain.getModules()[2].setOffsetAngle(
                SmartDashboard.getNumber("Swerve Module [3] Offset", drivetrain.getModules()[2].getOffsetAngle()));
        drivetrain.getModules()[3].setOffsetAngle(
                SmartDashboard.getNumber("Swerve Module [4] Offset", drivetrain.getModules()[3].getOffsetAngle()));

        drivetrain.getModules()[0].setInverted(
                SmartDashboard.getBoolean("Swerve Module [1] Offset", drivetrain.getModules()[0].getInverted()));
        drivetrain.getModules()[1].setInverted(
                SmartDashboard.getBoolean("Swerve Module [2] Offset", drivetrain.getModules()[1].getInverted()));
        drivetrain.getModules()[2].setInverted(
                SmartDashboard.getBoolean("Swerve Module [3] Offset", drivetrain.getModules()[2].getInverted()));
        drivetrain.getModules()[3].setInverted(
                SmartDashboard.getBoolean("Swerve Module [4] Offset", drivetrain.getModules()[3].getInverted()));
